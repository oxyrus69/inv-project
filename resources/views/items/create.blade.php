                ...
                <form x-ref="formItem" action="{{ route('items.store') }}" method="POST"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="name" x-model="form.name"
                            ...
                            required placeholder="Contoh: Laptop Gaming">
                        @error('name')
                    ...
                    <div class="mb-4">
                        ...
                        <select id="category-select" name="category_id" x-model="form.category_id"
                            class="shadow border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                            required>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div class="mb-4">
                            ...
                            <input type="number" name="quantity" x-model="form.quantity"
                                class="shadow border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                required placeholder="Contoh: 120 (Numerik)">
                            @error('quantity')
                                <span class="text-red-500 text-xs italic">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        <div class="sm:flex sm:items-start">
                            ...
                            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                <h3 class="text-lg leading-6 font-medium text-gray-900">Konfirmasi Simpan</h3>
                                <div class="mt-2">
                                    <p class="text-sm text-gray-500">
                                        Anda yakin sudah benar datanya?
                                    </p>
                                </div>
                            </div>
                        </div>
